...
export default function AboutProd(props) {
	...
	return (
		<section className="aboutProd">
			<div className="aboutProd__content">
				<div className="aboutProd__img">
					<img src={coffeProd} alt="coffee" />
				</div>
				<div className="aboutProd__item">
					<div className="aboutProd__title">
						<h3>{props.title}</h3>
					</div>
					...
					<div className="aboutProd__text">
						<p><span>Country: </span>{props.country} <br /> <br />
							...
							<br /><br />Price:  <span className='price'>{props.price}</span></p>
					</div>
				</div>
			</div>
		</section>
